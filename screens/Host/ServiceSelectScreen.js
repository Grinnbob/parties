...
services = [
  ...
  { id: 2, name: "Food & Beverages", asset: require("../../assets/img5.png") },
  ...
  { id: 6, name: "Cleaning Service", asset: require("../../assets/img9.png") },
];
...
const VendorProfileScreen = () => {
  ...
  const renderItem = ({ item }) => {
    return (
      ...
      >
        <ImageBackground
          source={item.asset ? item.asset : require("../../assets/img7.png")}
          style={{ width: "100%", height: 155, margin: 10, padding: 10 }}
      ...
      <View style={[styles.vendorprofilescreen, styles.progressIconLayout]}>
        ...
        >
          ...
          >
            <HStack>
              <MagnifyGlass />
              <Text fontSize={15} fontWeight={"300"} color={"#8A8A8A"} ml={3}>
                Search
              </Text>
            </HStack>
            <Filter />
        ...
        >
          ...
          >
            <FlatList data={services} renderItem={renderItem} numColumns={2} />
          </View>
          <View style={[styles.title, styles.titleFlexBox]}>
