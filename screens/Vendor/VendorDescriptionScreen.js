...
const VendorDescriptionScreen = () => {
    ...
    return (
      ...
      /> */}
            <Image
                style={[
                    styles.vendordescriptionscreenChild,
                    styles.tabPosition,
                ]}
                resizeMode="cover"
...
We've got it all! BBQ pit, lechon, beef brisket. Savory smoked for hours! Everything comes with ample homestyle sides, mash potatoes, corn bread, mac and cheese, and even cole slaw! Hire us today, we have great pricing!`}</Text>
            ...
            <View style={styles.user}>
                ...
                <View style={[styles.nameParent, styles.parentLayout]}>
                    <View style={styles.name}>
                        <Text style={styles.allAmericanBbq}>
                            All American BBQ Truck
                        </Text>
                    </View>
                    <View style={[styles.frameParent, styles.parentLayout]}>
                        <View>
                            <View style={styles.starsParent}>
                                <View
                                    style={[styles.stars, styles.tabsFlexBox]}
                                >
                                    <Image
                        ...
                        <Image
                            style={[
                                styles.iconsaxlinearexport,
                                styles.houseIconLayout,
                            ]}
                            resizeMode="cover"
            ...
            <View style={[styles.tab, styles.tabPosition]}>
                ...
                <View style={[styles.tabs, styles.tabsLayout]}>
                    ...
                    <View style={styles.tabbarTab}>
                        ...
                        />
                        <Text
                            style={[styles.inspirations, styles.servicesTypo]}
                        >
                            Inspirations
                        </Text>
                    </View>
                    ...
                    <View style={styles.tabbarTab}>
                        ...
                        />
                        <Text style={[styles.services, styles.titleClr]}>
                            Services
                        </Text>
                    </View>
                    <View style={styles.tabbarTab}>
            ...
            <View
                style={[styles.topnavigationContent, styles.planPartyPosition]}
            >
                ...
                <View style={[styles.rightAccessory, styles.accessoryPosition]}>
                    ...
                    <Image
                        style={[
                            styles.iconsaxlinearshoppingcart,
                            styles.houseIconLayout,
                        ]}
                        resizeMode="cover"
